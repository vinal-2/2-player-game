...
import { View, Text, StyleSheet, SafeAreaView, ImageBackground, Animated, PanResponder, Dimensions } from "react-native";
...
const PingPongGame: React.FC<PingPongGameProps> = ({ onGameOver }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Animated.View style={[styles.paddle, { transform: player1Position.getTranslateTransform() }]} {...player1PanResponder.panHandlers} />
      <Animated.View style={[styles.paddle, { transform: player2Position.getTranslateTransform() }]} {...player2PanResponder.panHandlers} />
